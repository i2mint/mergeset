...
**Shipped alongside:** a Claude Code subagent (`.claude/agents/mergeset-analyst.md`) and skill (`skills/mergeset/`), `docs/adr/` (the numbered decision records), `docs/RESEARCH.md` (the MUS/MSS and merge-queue literature, and what was deliberately not depended on).
